...
register_google(key="AIzaSylbIsE")
...
wifi_data <- read_excel("../Data/wifi_data.xlsx", col_names = T, sheet=1)
class(wifi_data)
...
if (!require(Hmisc)) install.packages("Hmisc") #컬럼명에 라벨을 붙이기 위한 패키지
